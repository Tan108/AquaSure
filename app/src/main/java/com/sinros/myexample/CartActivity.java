...
public class CartActivity extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = Config.IP+"/Bottle_App/showcart.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ChapterAdapter adapter = new ChapterAdapter(CartActivity.this,chapterList );
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrl,
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        try {
                           ...
                           // Toast.makeText(CartActivity.this, msg, Toast.LENGTH_LONG).show();
                             startActivity(new Intent(CartActivity.this,ChoosePaymentActivity.class));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(CartActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() {
